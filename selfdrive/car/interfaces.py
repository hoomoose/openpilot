...
class CarInterfaceBase(ABC):
  def __init__(self, CP, CarController, CarState):
    ...
    self.use_nnff = self.initialize_lat_torque_nn(CP.carFingerprint, eps_firmware) and lateral_tune and params.get_bool("NNFF")
    self.use_nnff_lite = lateral_tune and params.get_bool("NNFFLite")
